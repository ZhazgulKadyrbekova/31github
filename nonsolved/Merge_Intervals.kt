...
//    val arr = nonsolved.merge(arrayOf(intArrayOf(1,3), intArrayOf(2,6), intArrayOf(8,10), intArrayOf(15,18)))
//    for (i in arr)
//        for (j in i)
//            println(j)
//}
//
//fun nonsolved.merge(intervals: Array<IntArray>): Array<IntArray> {
